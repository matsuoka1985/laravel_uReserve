...
git clone https://github.com:matsuoka1985/laravel_uReserve.git

git clone ブランチを指定してダウンロードする場合

git clone -b ブランチ名 https://github.com:matsuoka1985/laravel_uReserve.git
...
HTMLを編集する際は、
npm run watchも実行しながら編集するようにしてください。
